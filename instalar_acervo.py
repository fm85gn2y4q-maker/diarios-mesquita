...
Aceita as duas origens. Este projeto usa a URL, porque o acervo comprimido tem
84 MB — acima dos 50 MB em que o GitHub adverte, e crescendo a cada coleta, o
que faria o histórico do Git engordar para sempre. O acervo de legislação, com
21 MB, viaja dentro do repositório; a diferença é de tamanho, não de método.

    python instalar_acervo.py https://…/diarios-mesquita-v1.0.0.db.gz \
        dados/diarios.sqlite <sha256>     # asset de release: é o que a imagem usa
    python instalar_acervo.py dist/diarios-mesquita-v1.0.0.db.gz \
        dados/diarios.sqlite <sha256>     # arquivo local, para conferir antes
